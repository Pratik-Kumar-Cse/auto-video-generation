...
Automate the creation of YouTube Video and Shorts , simply by providing a video topic to talk about.

## Installation 📥

`VideoGenerator` requires Python 3.11 to run effectively. If you don't have Python installed, you can download it from [here](https://www.python.org/downloads/).

After you finished installing Python, you can install `VideoGenerator` by following the steps below:
...
6. The video's location is `VideoGenerator/output.mp4`

## Automatic YouTube Uploading 🎥

VideoGenerator now includes functionality to automatically upload generated videos to YouTube.
